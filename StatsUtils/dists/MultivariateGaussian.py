...
class MultivariateGaussian:
	...
	def fitPDFMLE(self, ys: ndarray, sy: ndarray):
		raise NotImplementedError

	@classmethod
	def fitPointsMLE(cls, points: ndarray) -> None:
...
def decompose(c: ndarray) -> typing.Tuple[ndarray, ndarray]:
	S, e = scipy.linalg.eig(c)
	return np.real(S), np.real(e)


def fitSingleJointDistribution(points: ndarray) -> typing.Tuple[typing.Mapping, multivariate_normal_frozen, MultivariateBoundsT]:
